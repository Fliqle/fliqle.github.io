    ...
    <main className="mx-auto max-w-[692px] px-6 antialiased mt-12">
      <ArticleNav
        sections={[
          ...
          { id: "workshop", label: "Воркшоп в офисе ВКонтакте: 4 дня и 160 токенов" },
      ...
      <div className="text-gray-700 dark:text-gray-300 space-y-2 mb-48 leading-relaxed">
        ...
        <h2 id="workshop" className="font-medium mb-1 mt-10">Воркшоп в офисе ВКонтакте: 4 дня и 160 токенов</h2>
        <p className="mb-6">
