...
export default function ParadigmProject() {
  return (
    <main className="mx-auto max-w-[692px] px-6 antialiased mt-12">
      <ArticleNav
        sections={[
          { id: "2019-2021", label: "2019–2021: фундамент системы и миграция в Figma" },
          { id: "figma-migration", label: "Миграция из Sketch в Figma" },
          { id: "core-components", label: "Проектирование базовых UI-компонентов" },
          { id: "2021-2023", label: "2021–2023: масштабирование — токены VKUI и единая база знаний" },
          { id: "vkui-tokens", label: "Реархитектура дизайн-токенов VKUI" },
          { id: "site-relaunch", label: "Перезапуск сайта Paradigm" },
          { id: "pixso-rd", label: "Исследование и R&D: тестирование Pixso" },
          { id: "2024-2025", label: "2024–2025: единый мобильный опыт — Paradigm Mobile" },
          { id: "paradigm-mobile", label: "Создание Paradigm Mobile" },
          { id: "2025-2026", label: "2025–2026: от дизайнера к руководителю направления" },
          { id: "hiring-handoff", label: "Наем сотрудника и передача опердеятельности" },
          { id: "strategy-ai", label: "Стратегия, процессы и внедрение AI" },
          { id: "conclusion", label: "От создания кнопок к созданию среды" },
        ]}
      />
      <Link
        href="/"
      ...
      <div className="text-gray-700 dark:text-gray-300 space-y-2 mb-48 leading-relaxed">
        ...
        <h2 id="2019-2021" className="font-medium mb-1 mt-10">2019–2021: фундамент системы и миграция в Figma</h2>

        <h3 id="figma-migration" className="font-medium mb-1 mt-6">Миграция из Sketch в Figma</h3>
        <p className="mb-6">
        ...
        <h3 id="vkui-tokens" className="font-medium mb-1 mt-6">Реархитектура дизайн-токенов VKUI</h3>
        <p className="mb-6">
        ...
        <h3 id="pixso-rd" className="font-medium mb-1 mt-6">Исследование и R&D: тестирование Pixso</h3>
        <p className="mb-6">
        ...
        <h2 id="2024-2025" className="font-medium mb-1 mt-10">2024–2025: единый мобильный опыт — Paradigm Mobile</h2>
        <p className="mb-6">
        ...
        <h3 id="paradigm-mobile" className="font-medium mb-1 mt-6">Создание Paradigm Mobile</h3>
        <p className="mb-6">
        ...
        <h3 id="hiring-handoff" className="font-medium mb-1 mt-6">Наем сотрудника и передача опердеятельности</h3>
        <p className="mb-6">
        ...
        <h3 id="strategy-ai" className="font-medium mb-1 mt-6">Стратегия, процессы и внедрение AI</h3>
        <p className="mb-6">
        ...
        <h2 id="conclusion" className="font-medium mb-1 mt-10">От создания кнопок к созданию среды</h2>
        <p>
