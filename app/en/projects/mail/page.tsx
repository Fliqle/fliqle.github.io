...
export default function MailProject() {
  return (
    <main className="mx-auto max-w-[692px] px-6 antialiased mt-12">
      ...
      <h2 className="font-medium mb-1 mt-10">2019–2021: building Mail&apos;s product experience</h2>
      <p className="mb-6">
      ...
      <h3 className="font-medium mb-1 mt-6">Unified navigation</h3>
      <p className="mb-6">
      ...
      <h3 className="font-medium mb-1 mt-6">Launching the Payments hub inside Mail</h3>
      <p className="mb-6">
      ...
      <h3 className="font-medium mb-1 mt-6">New typography across all products</h3>
      <p className="mb-6">
      ...
      <h2 className="font-medium mb-1 mt-10">2025–2026: from designer to manager</h2>
      <p className="mb-6">
      ...
      <h3 className="font-medium mb-1 mt-6">Experiments with new scenarios</h3>
      <p className="mb-6">
      ...
      <h3 className="font-medium mb-1 mt-6">Mail&apos;s new home screen</h3>
      <p className="mb-6">
      ...
      <h3 className="font-medium mb-1 mt-6">Unified navigation for B2B and B2C</h3>
      <p className="mb-6">
      ...
      <h3 className="font-medium mb-1 mt-6">Leading the team</h3>
      <p className="mb-6">
      ...
      <h2 className="font-medium mb-1 mt-10">From doing it myself to creating the conditions for a team</h2>
      <p>
