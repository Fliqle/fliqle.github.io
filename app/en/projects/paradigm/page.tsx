  ...
  return (
    <main className="mx-auto max-w-[692px] px-6 antialiased mt-12">
      ...
      <div className="text-gray-700 dark:text-gray-300 space-y-2 mb-48 leading-relaxed">
        ...
        <h2 className="font-medium mb-1 mt-10">2019–2021: laying the foundation and migrating to Figma</h2>

        <h3 className="font-medium mb-1 mt-6">Migrating from Sketch to Figma</h3>
        <p className="mb-6">
        ...
        <h3 className="font-medium mb-1 mt-6">Designing the core UI components</h3>
        <p className="mb-6">
        ...
        <h2 className="font-medium mb-1 mt-10">2021–2023: scaling up — VKUI tokens and a unified knowledge base</h2>
        <p className="mb-6">
        ...
        <h3 className="font-medium mb-1 mt-6">Rearchitecting VKUI&apos;s design tokens</h3>
        <p className="mb-6">
        ...
        <h3 className="font-medium mb-1 mt-6">Relaunching the Paradigm website</h3>
        <p className="mb-6">
        ...
        <h3 className="font-medium mb-1 mt-6">R&amp;D: evaluating Pixso</h3>
        <p className="mb-6">
        ...
        <h2 className="font-medium mb-1 mt-10">2024–2025: one mobile experience — Paradigm Mobile</h2>
        <p className="mb-6">
        ...
        <h3 className="font-medium mb-1 mt-6">Building Paradigm Mobile</h3>
        <p className="mb-6">
        ...
        <h2 className="font-medium mb-1 mt-10">2025–2026: from designer to head of the direction</h2>
        <p className="mb-6">
        ...
        <h3 className="font-medium mb-1 mt-6">Hiring and handing off day-to-day work</h3>
        <p className="mb-6">
        ...
        <h3 className="font-medium mb-1 mt-6">Strategy, process, and adopting AI</h3>
        <p className="mb-6">
        ...
        <h2 className="font-medium mb-1 mt-10">From building buttons to building an environment</h2>
        <p>
