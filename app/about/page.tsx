      ...
      <article className="md:flex">
        ...
        <div className="relative pl-0 sm:pl-10">
          ...
          <ul className="list-disc list-outside text-gray-700 dark:text-gray-300 mt-2 space-y-2 mb-12 px-4">
            <li>Руководил развитием и внедрением дизайн-системы (токены, платформенные библиотеки). Сократил время сборки макетов и передачи в разработку за счет компонентов с высокой степенью повторного использования.</li>
            <li>Синхронизировал визуальный язык, типографику и паттерны между несколькими продуктовыми линейками, сформировав цельный пользовательский опыт на уровне компании.</li>
            <li>Оптимизировал процессы внутри команд: создаю инструменты, которые позволяют вносить дизайн-изменения без прямого участия дизайнеров, снижая операционную нагрузку.</li>
            <li>Сформировал стандарты качества и регламенты Design Review, упростив синхронизацию между дизайном, продуктовыми менеджерами и разработкой.</li>
            <li>Развиваю внутреннее и внешнее дизайн-сообщество: инициирую обмен практиками, хакатоны и командные активности, повышая вовлеченность и бренд работодателя.</li>
          </ul>
        </div>
      </article>
