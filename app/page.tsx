  ...
  return (
    <main className="mx-auto max-w-[692px] overflow-x-hidden px-6 antialiased ">
      ...
      <section className="max-w-4xl mx-auto py-16">
        <p className="mb-2">Я дизайнер с опытом больше 15 лет — люблю простые решения, за которыми стоит большая работа. Работал в VK над продуктами Mail: начинал с системных продуктовых интерфейсов, дорос до руководителя направления дизайна Mail и дизайн-системой Paradigm. Участвовал в крупных редизайнах, ребрендингах. Участвовал в разработке и развитии VKUI — основной дизайн-системы VK.</p>
        <span>
